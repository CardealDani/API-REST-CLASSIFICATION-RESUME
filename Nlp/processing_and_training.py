...
def train(df):
    X_train, X_test, y_train, y_test = train_test_split(df['tokens'], df['class_number'], test_size=0.25, random_state=None)
...
joblib.dump(model, 'model_class-up.pkl')
joblib.dump(vectorizer, 'vectorizer_class-up.pkl')
